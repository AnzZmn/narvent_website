...
export const TRACKS: Track[] = [
  {
    id: "white",
    label: "White Collar",
    subhead: "Cognitive, Desk-based, Tech-centric",
    cards: [
      {
        icon: "robot",
      ...
      },
      {
        ...
        blurb:
          "Convert prospects to customers across sectors (e.g., retail, healthcare, telecom).",
        points: [
      ...
      },
      {
        ...
        title: "Audit",
        blurb:
          "Full audits: stocks, compliance, fraud, competition via mystery/non-mystery audits.",
        points: [
  ...
  },
  {
    id: "grey",
    label: "Grey Collar",
    subhead: "Hybrid roles, Tech-assisted but operational",
    cards: [
      {
        icon: "phone",
        title: "Telecalling",
        blurb:
          "Flexible inbound/outbound telecalling via virtual call centers & configurable modules.",
        points: [
      ...
      },
      {
        ...
        blurb:
          "Compliance-focused cataloging & video moderation, scalable & cost-effective.",
        points: [
          "98%+ SLA adherence",
  ...
  },
  {
    id: "blue",
    label: "Blue Collar",
    subhead: "Manual, Field-intensive roles",
    cards: [
      {
        icon: "people",
        title: "Omni-staffing",
      ...
      },
      {
        ...
        blurb:
          "Optimize merchandising & branding with Awign's comprehensive solutions",
        points: [
          "PAN India Execution",
